...
public class PaymentController {
	...
	public PaymentController(OrderService orderService,UserService userService,OrderRepository orderRepository,ProductService productService,ProductRepository productRepository) {
	...
	public ResponseEntity<PaymentLinkResponse>createPaymentLink(@PathVariable Long orderId,
		...
		System.out.println(order.getId());
		 try {
		      ...
		      RazorpayClient razorpay = new RazorpayClient("rzp_test_PIkfahmdECwL7b", "qBNhKo6n8qdFsTYpuGNdJVWV");
...
//		order_id
  ...
  @GetMapping("/payments")
  public ResponseEntity<ApiResponse> redirect(@RequestParam("payment_id") String paymentId,@RequestParam("order_id")Long orderId) throws RazorpayException, OrderException {
	  RazorpayClient razorpay = new RazorpayClient("rzp_test_PIkfahmdECwL7b", "qBNhKo6n8qdFsTYpuGNdJVWV");
	  Order order =orderService.findOrderById(orderId);
