...
public class OrderServiceImplementation implements OrderService {
	...
	public OrderDisplayDTO findOrderByIdBro(Long orderId) throws OrderException {
		...
		if(opt.isPresent())
		{
			...
			hello.setTotalDiscountedPrice(order.getTotalDiscountedPrice());
...
//			hello.getUser().setFirstName("Hello Boi");
//			hello.getUser().setFirstName(each.getUser().getFirstName());
//			hello.getUser().setLastName(each.getUser().getLastName());
//			hello.getUser().setEmail(each.getUser().getEmail());
//			hello.getUser().setMobile(each.getUser().getMobile());
			...
			hello.setTotalDiscountedPrice(each.getTotalDiscountedPrice());
